...
export default function Hero() {
  return (
    ...
    >
      <div>
        <h1 className="font-playfair-display font-semibold l:text-2xl m:text-xl s:text-l text-secondary-light dark:text-secondary-dark">
          Software Engineer
        </h1>
      </div>

      <div className="flex flex-col l:gap-6 m:gap-4 s:gap-2">
        <p className="font-dm-sans l:text-l m:text-l s:text-m text-text-light dark:text-text-dark">
          Hi, I'm{" "}
          <span className="font-bold l:text-xl text-l text-text-important-light dark:text-text-important-dark">
            Huijing Jin
          </span>
          .
        </p>

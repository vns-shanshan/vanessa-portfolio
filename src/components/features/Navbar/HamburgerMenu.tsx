  ...
  return (
    <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
      ...
      >
        {/* First Line */}
        <div
          className={`m:w-8 m:h-1 s:w-6 s:h-0.5 bg-primary-light rounded-full transition-all duration-300 origin-center group-hover:rotate-15 ${
        ...
        {/* Second Line */}
        <div
          className={`m:w-8 m:h-1 s:w-6 s:h-0.5 bg-primary-light rounded-full transition-all duration-300 group-hover:-rotate-15 ${
      ...
      >
        ...
        >
          {/* First Line rotated */}
          <div className="m:w-8 m:h-1 s:w-6 s:h-0.5 bg-primary-light rounded-full transition-all duration-300 origin-center rotate-45 translate-y-2"></div>
          {/* Second Line rotated */}
          <div className="m:w-8 m:h-1 s:w-6 s:h-0.5 bg-primary-light rounded-full transition-all duration-300 origin-center -rotate-45 -translate-y-1"></div>
        </button>
